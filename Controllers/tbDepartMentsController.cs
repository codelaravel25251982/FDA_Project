...
{
    public class tbDepartMentsController : Controller
    {
        ...
        // GET: tbDepartMents/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: tbDepartMents/Create
